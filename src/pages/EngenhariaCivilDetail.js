...
import videoBackground from "../videos/engenhariacivilbg.mp4"
...
const MeioAmbienteDetail = () => {
  ...
  return (
    <Container id="EngenhariaCivilDetail">
      ...
      <Profile>
        ...
        <Heading>Engenharia Civil</Heading>
        
          <List>
            <Slide direction="left">
              <ServicesCard>
                <Item>Projetos básicos; </Item>
              </ServicesCard>
            </Slide>
            <Slide direction="up">
              <ServicesCard>
                <Item>Projetos executivos;</Item>
              </ServicesCard>
            </Slide>
            <Slide direction="left">
              <ServicesCard>
                <Item>Acompanhamento e supervisão de obras;</Item>
              </ServicesCard>
            </Slide>
            <Slide direction="up">
              <ServicesCard>
            ...
            <Slide direction="left">
              <ServicesCard>
                <Item>Projetos e estudos de viabilidade técnica, economica e ambiental;</Item>
              </ServicesCard>
            </Slide>
            <Slide direction="up">
              <ServicesCard>
                <Item>Projetos de sistema de água e esgoto para loteamento;</Item>
              </ServicesCard>
            </Slide>
            <Slide direction="left">
              <ServicesCard>
                <Item>As built de loteamentos;</Item>
              </ServicesCard>
            </Slide>
