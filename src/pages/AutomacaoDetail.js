...
import videoBackground from "../videos/automacaobgdetail.mp4"
import { AiOutlineArrowLeft } from "react-icons/ai"; // Importe o ícone AiOutlineArrowLeft do pacote react-icons

const AutomacaoDetail = () => {
  const handleGoBack = () => {
    window.history.back();
  };

  return (
    <Container id="AutomacaoDetail">
      ...
      <Profile>
        ...
        <Heading>Automação</Heading>
        
          <List>
            <Slide direction="left">
              <ServicesCard>
                <Item>Automação de sistema de bombeamento de água e efluentes; </Item>
              </ServicesCard>
            </Slide>
            <Slide direction="up">
              <ServicesCard>
                <Item>Capacitação tecnica para operação de ETE e aterro sanitário;</Item>
              </ServicesCard>
            </Slide>
            <Slide direction="left">
              <ServicesCard>
                <Item>Telemetria de hidrômetros;</Item>
              </ServicesCard>
            </Slide>
            <Slide direction="up">
...
export default AutomacaoDetail;
